...
1. **[REF_CLAUDE_CONTEXT.md](REF_CLAUDE_CONTEXT.md)** 🔥 - Claude AI 온보딩, 전체 시스템 구조
2. **[LOG_작업이력.md](LOG_작업이력.md)** 🔥 - Week 1~6 작업 완료 내역
3. **[00_업무계획서.md](00_업무계획서.md)** 🔥 - 전체 업무 계획 및 일정
4. **[../CDSS 프로젝트 인수인계 문서.md](../CDSS%20프로젝트%20인수인계%20문서.md)** 🔥 - 프로젝트 인수인계 요약
...
| 12 | [보안_아키텍처_정책.md](12_보안_아키텍처_정책.md) | 보안 정책 | 📌 참고 |
...
| 문서명 | 설명 |
|---|---|
| [LOG_작업이력.md](LOG_작업이력.md) | 주차별 작업 완료 보고서 (Week 1~6) |
