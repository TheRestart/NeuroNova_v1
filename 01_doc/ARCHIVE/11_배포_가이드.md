...
# cdss-django-api        django-api          running             8000/tcp
# cdss-django-channels   django-channels     running             8001/tcp
# cdss-celery-worker     celery-worker       running
# cdss-celery-beat       celery-beat         running
# cdss-rabbitmq          rabbitmq            running             5672/tcp, 15672/tcp
# cdss-mysql             mysql               running             3306/tcp
# cdss-redis             redis               running             6379/tcp
# cdss-minio             minio               running             9000/tcp, 9001/tcp
# cdss-ai-server         ai-server           running             5000/tcp
# cdss-prometheus        prometheus          running             9090/tcp
# cdss-grafana           grafana             running             3000/tcp
# cdss-alertmanager      alertmanager        running             9093/tcp
```
...
server {
    listen 80;
    server_name api.cdss.hospital.com cdss.hospital.com;
...
server {
    ...
    server_name api.cdss.hospital.com;
    ...
    location /api/ {
        ...
        # CORS 헤더 (Django에서 처리하지만 Nginx에서도 설정 가능)
        add_header Access-Control-Allow-Origin https://cdss.hospital.com always;
    ...
    # Health Check
    location /health/ {
        proxy_pass http://django_api/health/;
        access_log off;
    }
}
