...
SECRET_KEY = "django-insecure-+wog6_b&(283d(9310a3v68rw_fd25%d0q48a79r*a%kydqtah"
...
# 보안 설정 토글 (개발/프로덕션)
# .env 파일에서 ENABLE_SECURITY=true로 설정하면 보안 활성화
